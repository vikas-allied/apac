                    ...
                    <div class="card mb-4"> <!--begin::Header-->
                        <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3"> <label for="role_name" class="form-label">Role Name</label> <input type="text" class="form-control @error('role_name') is-invalid @enderror" id="role_name" name="role_name" placeholder="Enter role" value="{{ $role->name }}" required> </div>
                                @error('role_name')
